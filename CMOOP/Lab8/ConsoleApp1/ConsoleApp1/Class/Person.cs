...
namespace Nomer
{
    public class Person : ICloneable, IComparable<Person>
    {
        ...
        public object Clone() => new Person(FirstName, LastName, BirthDate);

        public int CompareTo(Person other)
        {
            if (other == null) return 1;
            int res = string.Compare(LastName, other.LastName);
            return res != 0 ? res : string.Compare(FirstName, other.FirstName);
        }
    }
